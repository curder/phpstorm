    ...
    return [
        {
            ...
            items: [
                ...
                {text: "重构变量名和方法", link: "/guide/refactoring-for-property-and-method"},
                {text: "重构之父子类之间转移方法", link: "/guide/refactoring-for-pull-members-up"},
                {text: "重构之接口", link: "/guide/refactoring-for-extract-interface"},
